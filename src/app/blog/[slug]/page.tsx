...
const articleContent: Record<string, { title: string; description: string; body: string[] }> = {
  "quand-changer-pneus-voiture": {
    ...
    body: [
      ...
      "**2. Des craquelures ou boursouflures sur les flancs.** Le caoutchouc vieillit avec le temps, même si vous roulez peu. Des fissures sur les flancs indiquent un vieillissement du pneu qui peut mener à un éclatement. Un pneu de plus de 5 ans doit être inspecté par un professionnel.",
  ...
  "pneus-ete-hiver-toutes-saisons-differences": {
    ...
    body: [
      ...
      "**Les pneus toutes saisons** combinent des caractéristiques des deux types. Ils portent le marquage 3PMSF et sont légalement acceptés en zone montagne. Leur point fort : vous n'avez pas besoin de faire deux changements par an. Leur point faible : ils ne sont pas aussi performants qu'un pneu été en été, ni qu'un pneu hiver en hiver.",
  ...
  "meilleurs-pneus-michelin-continental-bridgestone": {
    ...
    body: [
      ...
      "**Conclusion :** Il n'y a pas de mauvais choix entre ces trois marques. Pour la longévité et la polyvalence, choisissez Michelin. Pour la sécurité sur mouillé, optez pour Continental. Pour les pneus hiver et sport, Bridgestone est imbattable.",
  ...
  "freinage-quand-changer-plaquettes-disques": {
    ...
    body: [
      ...
      "**Le bruit au freinage.** Un grincement ou un couinement lors du freinage est souvent le premier signe que vos plaquettes arrivent en fin de vie. Les plaquettes intègrent un témoin sonore qui produit ce bruit volontairement. Si vous entendez un bruit métallique crissant, c'est urgent : le métal frotte directement sur le disque.",
