...
export const articles = [
  {
    slug: "quand-changer-pneus-voiture",
    title: "Quand faut-il changer ses pneus ? Les 5 signes à ne pas ignorer",
    excerpt:
      "Profondeur des rainures, craquelures, vibrations au volant… Découvrez comment savoir si vos pneus sont en fin de vie et évitez les accidents.",
    category: "Conseils",
    readTime: "4 min",
    image: "/images/categories/summer.jpg",
    keywords: ["quand changer pneus", "pneus usés", "profondeur pneus", "sécurité pneus"],
  },
  {
    slug: "pneus-ete-hiver-toutes-saisons-differences",
    title: "Pneus été, hiver ou toutes saisons : lequel choisir pour votre véhicule ?",
    excerpt:
      "Comparatif complet des trois types de pneus. Performances, prix, conditions d'utilisation : faites le bon choix pour rouler en toute sécurité toute l'année.",
    category: "Guide",
    readTime: "6 min",
    image: "/images/categories/allseason.jpg",
    keywords: ["pneus été hiver différence", "pneus toutes saisons", "choisir ses pneus"],
  },
  {
    slug: "meilleurs-pneus-michelin-continental-bridgestone",
    title: "Michelin, Continental ou Bridgestone : quelle est la meilleure marque de pneus ?",
    excerpt:
      "Comparatif des trois plus grandes marques de pneus : qualité, prix, longévité et performance sur mouillé. Guide d'achat par nos experts.",
    category: "Comparatif",
    readTime: "7 min",
    image: "/images/categories/summer.jpg",
    keywords: ["Michelin Continental Bridgestone comparatif", "meilleure marque pneus", "pneus Michelin avis"],
  },
  {
    slug: "freinage-quand-changer-plaquettes-disques",
    title: "Freinage : comment savoir si vos plaquettes ou disques sont à changer ?",
    excerpt:
      "Bruit au freinage, distance d'arrêt plus longue, voyant allumé… Nos techniciens vous expliquent les signes d'usure du système de freinage.",
    category: "Entretien",
    readTime: "5 min",
    image: "/images/categories/brakes.jpg",
    keywords: ["plaquettes frein usées", "disques frein changer", "bruit freinage", "entretien freins"],
  },
  {
    slug: "pneus-4x4-suv-choisir",
    title: "Pneus 4x4 et SUV : comment choisir les meilleurs pneus pour votre gros véhicule ?",
    excerpt:
      "SUV, crossover, 4x4 : leurs pneus ont des exigences spécifiques. Découvrez les critères essentiels et les meilleures marques pour rouler en sécurité.",
    category: "Guide",
    readTime: "5 min",
    image: "/images/categories/suv.jpg",
    keywords: ["pneus SUV choisir", "pneus 4x4 recommandés", "meilleurs pneus SUV"],
  },
  {
    slug: "vidange-huile-quand-comment",
    title: "Vidange huile moteur : quand la faire et pourquoi c'est essentiel ?",
    excerpt:
      "Kilométrage recommandé, types d'huile, durée d'intervention… Tout ce que vous devez savoir sur la vidange pour protéger votre moteur.",
    category: "Entretien",
    readTime: "4 min",
    image: "/images/categories/brakes.jpg",
    keywords: ["vidange huile voiture", "quand faire vidange", "entretien moteur voiture"],
  },
];
